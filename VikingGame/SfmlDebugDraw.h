...
namespace sfdd
{
	const float PIXELS_PER_METER = 327.0f;
}
...
public:
	...
	{
		return sf::Vector2f(vector.x * (scaleToPixels ? sfdd::PIXELS_PER_METER : 1.f), vector.y * (scaleToPixels ? sfdd::PIXELS_PER_METER : 1.f));
	}
